...
namespace {
    const Vector3 START_POS = {  0.0f, -250.0f, 0.0f }; // 左下
    const Vector3 SOUND_POS = {  600.0f, -250.0f, 0.0f }; // 右下
    const Vector3 OP_POS = { -600.0f,   -250.0f, 0.0f }; // 左上
    //const Vector3 RULE_POS = { 300.0f,   50.0f, 0.0f }; // 右上 (未実装)
}
